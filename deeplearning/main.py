...
def get_args():
    ...
    p.add_argument('--best-n1-kernel', type=int, default=10)
...
def train(args):
    ...
    for step in range(args.train_steps):
        ...
        logits = model(x)
        # print(logits.shape)
        # Cast labels (targets) to LongTensor as per Piazza post https://piazza.com/class/kdfbbwz3hwb3an?cid=562
